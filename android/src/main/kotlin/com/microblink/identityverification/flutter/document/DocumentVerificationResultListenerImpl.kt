...
import com.microblink.documentverification.entities.recognizers.blinkid.generic.imageanalysis.ImageAnalysisResult
import com.microblink.identityverification.docver.manager.config.api.DocumentVerificationResultListener
import com.microblink.identityverification.docver.result.api.DocumentVerificationResult
...
class DocumentVerificationResultListenerImpl(private val idvDartApi: IdvDartApi) :
    DocumentVerificationResultListener {
    ...
    override fun onResultConfirmed(
        ...
        val dartDocResult = DartConfig.DocumentResult.Builder()
