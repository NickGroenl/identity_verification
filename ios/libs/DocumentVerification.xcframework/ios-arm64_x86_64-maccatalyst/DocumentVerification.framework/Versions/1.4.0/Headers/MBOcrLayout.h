...
@interface MDVOcrLayout : NSObject
 ...
 */
@property (nonatomic) NSArray<MDVOcrBlock *> *blocks;
 ...
 */
@property (nonatomic) MDVPosition *position;
 ...
 */
- (instancetype)initWithOcrBlocks:(NSArray<MDVOcrBlock *> *)ocrBlocks
 ...
 */
MB_CLASS_AVAILABLE_IOS(11.0)
@interface MDVOcrBlock : NSObject

/**
 * Ocr lines of the block
 */
@property (nonatomic) NSArray<MDVOcrLine *> *lines;
 ...
 */
- (instancetype)initWithOcrLines:(NSArray<MDVOcrLine *> *)ocrLines position:(MDVPosition *)position NS_DESIGNATED_INITIALIZER;
 ...
 */
MB_CLASS_AVAILABLE_IOS(11.0)
@interface MDVOcrLine : NSObject

/**
 * Ocr chars of the line
 */
@property (nonatomic) NSArray<MDVCharWithVariants *> *chars;
 ...
 */
- (instancetype)initWithOcrChars:(NSArray<MDVCharWithVariants *> *)ocrChars position:(MDVPosition *)position NS_DESIGNATED_INITIALIZER;
...
MB_CLASS_AVAILABLE_IOS(11.0)
@interface MDVCharWithVariants : NSObject

/**
 * Character that was recognised
 */
@property (nonatomic) MDVOcrChar * character;
 ...
 */
- (instancetype)initWithValue:(MDVOcrChar *)character NS_DESIGNATED_INITIALIZER;
 ...
 */
@property (nonatomic) MDVOcrFont font;
 ...
 */
- (instancetype)initWithValue:(unichar)value position:(MDVPosition *)position height:(CGFloat)height NS_DESIGNATED_INITIALIZER;
 ...
 */
MB_CLASS_AVAILABLE_IOS(11.0)
@interface MDVPosition : NSObject
 ...
 */
- (MDVPosition *)positionWithOffset:(CGPoint)offset;
