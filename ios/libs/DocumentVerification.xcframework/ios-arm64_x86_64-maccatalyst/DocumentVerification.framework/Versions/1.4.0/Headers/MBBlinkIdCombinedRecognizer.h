...
@protocol MDVBlinkIdCombinedRecognizerDelegate;
...
@interface MDVBlinkIdCombinedRecognizer : MDVRecognizer<NSCopying, MDVCombinedRecognizer, MDVFaceImage, MDVEncodeFaceImage, MDVFaceImageDpi, MDVFullDocumentImage, MDVEncodeFullDocumentImage, MDVFullDocumentImageDpi, MDVFullDocumentImageExtensionFactors, MDVSignatureImage, MDVSignatureImageDpi, MDVEncodeSignatureImage, MDVCameraFrames>
 ...
 */
@property (nonatomic, strong, readonly) MDVBlinkIdCombinedRecognizerResult *result;

/**
* Full document dewarped imagedelegate
*/
@property (nonatomic, nullable, weak) id<MDVBlinkIdCombinedRecognizerDelegate> dewarpedImageDelegate;

/**
* Document not supported classifier delegate
*/
@property (nonatomic, nullable, weak) id<MDVBlinkIdCombinedRecognizerDelegate> classifierDelegate;

/**
 * Class filter delegate
 */
@property (nonatomic, nullable, weak) id<MDVBlinkIdCombinedRecognizerDelegate> classFilterDelegate;

/**
 * Barcode started scanning delegate
 */
@property (nonatomic, nullable, weak) id<MDVBlinkIdCombinedRecognizerDelegate> barcodeScanningStartedDelegate;
 ...
 *
 * Default: MDVAnonymizationModeFullResult
 */
@property (nonatomic, assign) MDVAnonymizationMode anonymizationMode;
 ...
 */
@property (nonatomic, strong) MDVRecognitionModeFilter *recognitionModeFilter;
...
@protocol MDVBlinkIdCombinedRecognizerDelegate <NSObject>
@optional

/**
 * Called when dewarped full document image is available
*/
- (void)onCombinedImageAvailable:(nullable MDVImage *)dewarpedImage;
...
*/
- (BOOL)combinedClassInfoFilter:(nullable MDVClassInfo *)classInfo;
