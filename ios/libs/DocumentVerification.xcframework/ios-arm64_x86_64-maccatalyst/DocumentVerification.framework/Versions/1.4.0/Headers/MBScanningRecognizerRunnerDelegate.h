 ...
 */
@protocol MDVScanningRecognizerRunnerDelegate <NSObject>
@required
/**
...
- (void)recognizerRunner:(nonnull MDVRecognizerRunner *)recognizerRunner didFinishScanningWithState:(MDVRecognizerResultState)state;
