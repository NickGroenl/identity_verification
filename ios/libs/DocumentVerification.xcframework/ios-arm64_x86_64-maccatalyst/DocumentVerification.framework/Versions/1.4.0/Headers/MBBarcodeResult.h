...
@interface MDVBarcodeResult : NSObject
 ...
 */
@property(nonatomic, assign, readonly) MDVBarcodeType barcodeType;
...
*/
@property (nonatomic, readonly, nullable) MDVBarcodeElements *extendedElements;
