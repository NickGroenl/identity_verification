...
/**
 ...
 Those are events specified by MDVOverlayViewControllerDelegate protocol.
 */
@protocol MDVOverlayContainerViewController <MDVRecognizerRunnerViewController>
 ...
 */
- (void)overlayViewControllerWillCloseCamera:(MDVOverlayViewController *)overlayViewController;
 ...
 */
- (BOOL)overlayViewControllerShouldDisplayTorch:(MDVOverlayViewController *)overlayViewController;
 ...
 */
- (BOOL)overlayViewController:(MDVOverlayViewController *)overlayViewController willSetTorch:(BOOL)isTorchOn;

/**
 * If help mechanism is implemented using MDVScanDelegate's scanningViewControllerWillPresentHelp method,
