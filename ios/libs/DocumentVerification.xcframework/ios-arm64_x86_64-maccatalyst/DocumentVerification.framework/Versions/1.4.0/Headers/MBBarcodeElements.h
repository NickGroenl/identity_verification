...
@interface MDVBarcodeElements : NSObject<NSCopying>
...
/**
 * Get value for wanted MDVBarcodeElementKey
 *
 * @param key The input value representing one key from MDVBarcodeElementKey enum
 * @return NSString The string for scanned barcode element key value
 */
- (NSString *)getValue:(MDVBarcodeElementKey)key;
