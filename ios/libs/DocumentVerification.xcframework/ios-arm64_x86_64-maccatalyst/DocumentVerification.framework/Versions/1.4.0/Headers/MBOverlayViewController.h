...
@interface MDVOverlayViewController : UIViewController
 ...
 */
@property (nonatomic, weak) UIViewController<MDVOverlayContainerViewController> *recognizerRunnerViewController;
