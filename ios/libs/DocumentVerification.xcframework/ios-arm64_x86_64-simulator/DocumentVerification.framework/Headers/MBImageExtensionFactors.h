 ...
 */
typedef struct MDVImageExtensionFactors {
    CGFloat top;
    CGFloat right;
    CGFloat bottom;
    CGFloat left;
} MDVImageExtensionFactors;

/**
 * Method which creates a image extension factors structure
 */
NS_INLINE MDVImageExtensionFactors MDVMakeImageExtensionFactors(CGFloat top, CGFloat right, CGFloat bottom, CGFloat left) {
    MDVImageExtensionFactors factors;
    factors.top = top;
    factors.right = right;
