...
@interface MDVViewControllerFactory : NSObject
 ...
 * The only requirement for the overlay view is that it's a subclass of MDVOverlayViewController
 *
 ...
 */
+ (nullable UIViewController<MDVRecognizerRunnerViewController> *)recognizerRunnerViewControllerWithOverlayViewController:(nonnull MDVOverlayViewController *)overlayViewController NS_SWIFT_NAME(recognizerRunnerViewController(withOverlayViewController:));
