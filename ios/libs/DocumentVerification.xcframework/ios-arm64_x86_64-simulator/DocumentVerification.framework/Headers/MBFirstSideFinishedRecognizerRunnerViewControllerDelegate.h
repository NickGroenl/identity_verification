...
@protocol MDVFirstSideFinishedRecognizerRunnerViewControllerDelegate <NSObject>
@required
 ...
 */
- (void) recognizerRunnerViewControllerDidFinishRecognitionOfFirstSide:(nonnull UIViewController<MDVRecognizerRunnerViewController> *)recognizerRunnerViewController;
