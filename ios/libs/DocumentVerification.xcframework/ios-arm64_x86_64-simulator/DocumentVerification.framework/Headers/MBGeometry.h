...
#define NULL_LINE CGLineMake(NULL_POINT, NULL_POINT)
...
// Create point with given offset from given point
...
CGFloat CGLineDirection(CGLine line);

// Returns the angle between two given lines, in radians
CGFloat CGLinesAngle(CGLine line1, CGLine line2);
...
MB_EXTERN CGRect MDVscanningRegionForFrameInBounds(CGRect frame, CGRect bounds);
