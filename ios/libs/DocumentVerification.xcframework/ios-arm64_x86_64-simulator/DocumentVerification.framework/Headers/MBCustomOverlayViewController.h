...
@interface MDVCustomOverlayViewController : MDVOverlayViewController

@property (nonatomic, readonly, strong) MDVRecognizerCollection *recognizerCollection;
@property (nonatomic, readonly, strong) MDVCameraSettings *cameraSettings;
@property (nonatomic, strong) MDVRecognizerRunnerViewControllerMetadataDelegates *metadataDelegates;
@property (nonatomic, weak) id<MDVScanningRecognizerRunnerViewControllerDelegate> scanningRecognizerRunnerViewControllerDelegate;
@property (nonatomic, weak) id<MDVRecognizerRunnerViewControllerDelegate> recognizerRunnerViewControllerDelegate;

/**
 * Convenience initializer used for use cases when overlay view controller is instantiated from storyboard.
 * It creates default MDVCameraSettings and empty MDVRecognizerCollection. To add recognizers after this
 * initializer is used, please use reconfigureRecognizers:.
 */
- (instancetype)init;

- (instancetype)initWithRecognizerCollection:(MDVRecognizerCollection *)recognizerCollection cameraSettings:(MDVCameraSettings *)cameraSettings NS_DESIGNATED_INITIALIZER;
