 ...
 */
@protocol MDVBlinkIdOverlayViewControllerDelegate <NSObject>
@required
/**
 ...
 * - each scanning result belongs to a common MDVRecognizerResult type
 ...
 *
 */
- (void)blinkIdOverlayViewControllerDidFinishScanning:(nonnull MDVBlinkIdOverlayViewController *)blinkIdOverlayViewController state:(MDVRecognizerResultState)state;
 ...
 */
- (void)blinkIdOverlayViewControllerDidTapClose:(nonnull MDVBlinkIdOverlayViewController *)blinkIdOverlayViewController;
 ...
 *  @param blinkIdOverlayViewController blinkIdOverlayViewController Scanning view controller responsible for scanning
 */
- (void)blinkIdOverlayViewControllerDidFinishScanningFirstSide:(nonnull MDVBlinkIdOverlayViewController *)blinkIdOverlayViewController;
