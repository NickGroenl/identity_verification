 ...
 */
typedef NS_ENUM(NSInteger, MDVMrtdDocumentType) {
    MDVMrtdTypeUnknown,

    /** Identity card */
    MDVMrtdTypeIdentityCard,
    ...
    /** US Green Card */
    MDVMrtdTypeGreenCard,
    
    /** Malaysian PASS type IMM13P */
    MDVMrtdTypeMysPassIMM13P,
    
    /** One liner ISO DL */
    MDVMrtdTypeDl,
    
    /** China mainland travel permit */
    MDVMrtdTypeInternalTravelDocument,
    
    /** Border crossing card  */
    MDVMrtdTypeBorderCrossingCard

};

MB_CLASS_AVAILABLE_IOS(11.0) MB_FINAL
@interface MDVMrzResult : NSObject<MDVAgeResult>
 ...
 */
@property (nonatomic, assign, readonly) MDVMrtdDocumentType documentType;
 ...
 */
@property (nonatomic, strong, readonly) MDVDateResult *dateOfBirth;
 ...
 */
@property (nonatomic, strong, readonly) MDVDateResult *dateOfExpiry;
