 ...
 */
@protocol MDVScanningRecognizerRunnerViewControllerDelegate <NSObject>
@required
/**
...
- (void)recognizerRunnerViewControllerDidFinishScanning:(nonnull UIViewController<MDVRecognizerRunnerViewController> *)recognizerRunnerViewController state:(MDVRecognizerResultState)state;
