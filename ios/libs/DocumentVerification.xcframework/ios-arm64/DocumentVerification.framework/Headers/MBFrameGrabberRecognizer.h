...
@protocol MDVFrameGrabberRecognizerDelegate;
...
@interface MDVFrameGrabberRecognizer : MDVRecognizer<NSCopying>

- (instancetype)init NS_UNAVAILABLE;
- (instancetype)initWithFrameGrabberDelegate:(id<MDVFrameGrabberRecognizerDelegate>)frameGrabberDelegate NS_SWIFT_NAME(init(frameGrabberDelegate:));

/**
 * Allow sending focused camera frames to MDVFrameGrabberRecognizerDelegate.
 *
 * Default: YES
 */
...
/**
 * Allow sending unfocused camera frames to MDVFrameGrabberRecognizerDelegate.
 *
 * Default: NO
 */
...
@protocol MDVFrameGrabberRecognizerDelegate <NSObject>
@required
/**
 ...
 * @param cameraFrame The {MDVImage} containing frame that will be processed.
 ...
 */
- (void)onFrameAvailable:(MDVImage *)cameraFrame isFocused:(BOOL)focused frameQuality:(CGFloat)frameQuality;
