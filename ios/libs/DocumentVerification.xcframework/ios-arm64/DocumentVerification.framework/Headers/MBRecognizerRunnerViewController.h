...
@class MDVOverlayViewController;
@class MDVImage;

/** Block for returning high resolution MDVImage photo with capture or still output */
typedef void(^MDVCaptureHighResImage)(MDVImage * _Nullable highResImage);
 ...
 */
@protocol MDVRecognizerRunnerViewController <NSObject>

/**
 * MDVRecognizerRunnerViewController's shouldAutorotate will return this value.
 *
 * Default: NO.
 *
...
/**
 * MDVRecognizerRunnerViewController's supportedInterfaceOrientations will return this value.
 *
 ...
 * Play scan sound.
 *
 * It uses default scan sound, you can change it by setting your own soundFilePath in MDVOverlaySettings.
 */
 ...
 */
- (void)captureHighResImage:(MDVCaptureHighResImage)highResoulutionImageCaptured;
